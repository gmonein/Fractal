...
# define KRN_RT_ID			0
# define KRN_PATH_ID		1
# define NB_KRN				2

# define KRN_NAME			"core"
# define KRN_NBSOURCE		1
# define KRN_SRCPATH		(char*[]){"srcs/fractol.cl"}
# define KRN_NBARG			2
# define KRN_MEMARG			(int[]){MEM_PIXEL_ID, MEM_ARG_ID}
# define KRN_CMPFLG			"-I includes -cl-fast-relaxed-math"
# define KRN_WRKDIM			2
# define KRN_GWRKSIZE		(size_t[3]){WIN_H - MINI_FRAC_H, WIN_W, 0}
